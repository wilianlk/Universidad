    ...
    <div class="col-xs-12 col-sm-12">
          <div class="panel panel-primary">
            <div class="panel-heading">Editar Materia</div>
              ...
              {!!Form::model($electivas,['route'=>['electiva.update',$electivas->id],'method'=>'PUT'])!!}
              <div class="col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    ...
                    {!!Form::select('profesor_id', $profesor, null,['id'=>'profesor_id', 'class'=>'form-control']) !!}
                </div>
                <div class="form-group">
              ...
              <div class="col-md-8 col-md-offset-2">
               ...
               {!! Form::submit('Editar Materia',['class'=>'btn btn-success']) !!}
               {!! Form::close() !!}
              </div>
